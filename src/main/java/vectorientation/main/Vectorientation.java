...
public class Vectorientation implements ClientModInitializer {
	...
	public static String VAR_SQUETCH = "squetch";
        ...
        public static String VAR_MOB_SQUETCH = "mob_squetch";
        public static String VAR_MOB_MIN_WARP = "mob_min_warp";
        public static String VAR_MOB_WARP_FACTOR = "mob_warp_factor";
        ...
        public static boolean MOB_SQUETCH = CONFIG.getOrDefault(VAR_MOB_SQUETCH, true);
        public static double MOB_MIN_WARP = CONFIG.getOrDefault(VAR_MOB_MIN_WARP, 0.75d);
        public static double MOB_WARP_FACTOR = CONFIG.getOrDefault(VAR_MOB_WARP_FACTOR, 1.0d);
	...
	public void onInitializeClient() {
        ...
        private static void parseMobBlacklist(){
                ...
                if(MOB_BLACKLIST_STRING.isEmpty()) return;
	...
	public static void setConfig(String key, String value){
		CONFIG.set(key, value);
                ...
                if(key.equals(VAR_MOB_SQUETCH)) MOB_SQUETCH = CONFIG.getOrDefault(key, true);
                if(key.equals(VAR_MOB_MIN_WARP)) MOB_MIN_WARP = CONFIG.getOrDefault(key, 0.75d);
                if(key.equals(VAR_MOB_WARP_FACTOR)) MOB_WARP_FACTOR = CONFIG.getOrDefault(key, 1.0d);
	...
	private static String provider( String filename ) {
		return "# Enable Squash & Stretch:\n"
				...
				+ "min_warp=0.75\n"
                                ...
                                + "minecarts=false\n\n"
                                + "# Enable Squash & Stretch for mobs:\n"
                                + "mob_squetch=true\n"
                                + "# Vertical squish at 0 velocity for mobs:\n"
                                + "mob_min_warp=0.75\n"
                                + "# Amount of squish increase with velocity for mobs:\n"
                                + "mob_warp_factor=1.0\n"
